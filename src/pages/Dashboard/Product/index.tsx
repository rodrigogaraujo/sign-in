...
const Customer = () => {
    ...
    const handleSelecType = useCallback((options: any) => {
        if (options) setTypeProduct(options.value);
    }, []);

    const handleSelectUnity = useCallback((options: any) => {
        if (options) setUnity(options.value);
    }, []);
